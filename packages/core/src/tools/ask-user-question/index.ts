...
export function createAskUserQuestionTool(
  ...
  return buildTool({
    ...
    async execute(input) {
      ...
      onQuestion({ id: crypto.randomUUID(), questions })
      return {
